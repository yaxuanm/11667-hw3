...
class EncoderModel(nn.Module):
    ...
    def pooling(self, last_hidden_state, attention_mask):
        ...
        # We need to find the last 1 in each row
    ...
    def compute_similarity(self, q_reps, p_reps, temperature):
        ...
        # q_reps: (n_queries, hidden_dim)
        # p_reps: (n_passages, hidden_dim)
        # Result: (n_queries, n_passages)
    ...
    def compute_labels(self, n_queries, n_passages):
        ...
        # Query i has positive passage at index i * passages_per_query
    ...
    def compute_loss(self, scores, target):
        ...
        # scores: (n_queries, n_passages) - logits for each query-passage pair
        # target: (n_queries) - indices of positive passages for each query
